...
def txtLabel_to_xmlLabel(classes_file,source_txt_path,source_img_path,save_xml_path):
    ...
    for file in os.listdir(source_txt_path):
        ...
        os.remove(f"train/labels/{file}")

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--classes_file', type=str, default="data.names")
    parser.add_argument('--source_txt_path', type=str, default="./train/labels")
    parser.add_argument('--source_img_path', type=str, default="./train/images")
    parser.add_argument('--save_xml_path', type=str, default="./train/labels")
